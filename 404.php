...
<?php $this->need('views/components/sidebar-left.php'); ?>
        ...
        <div class="error-404">
            ...
            <h2 class="error-message"><?php _e('页面不存在'); ?></h2>
            <p class="error-description"><?php _e('抱歉，您访问的页面可能已被删除、移动或输入了错误的地址。'); ?><br><?php _e('不过别担心，您可以通过以下方式找到您需要的内容。'); ?></p>
            
            <!-- 搜索框 -->
            <div class="search-box">
                <form method="post" action="<?php $this->options->siteUrl(); ?>">
                    <input type="text" name="s" placeholder="<?php _e('搜索您想找的内容...'); ?>" aria-label="<?php _e('搜索'); ?>" />
            ...
            <div class="error-actions">
                <a href="#" class="btn btn-secondary" onclick="history.back(); return false;"><i class="fa fa-arrow-left"></i> <?php _e('返回上一页'); ?></a>
                <a href="<?php $this->options->siteUrl(); ?>" class="btn btn-primary"><i class="fa fa-home"></i> <?php _e('返回首页'); ?></a>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="content-block">
                    ...
                    <ul>
                        ...
                        <?php endwhile; ?>
                        <li><a href="<?php echo htmlspecialchars(dygita_get_archives_url($this->options), ENT_QUOTES, 'UTF-8'); ?>"><i class="fa fa-archive"></i> <?php _e('归档'); ?></a></li>
                    </ul>
                </div>
