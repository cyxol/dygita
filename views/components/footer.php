...
<footer class="footer">
    <div class="footer-inner">
        <div class="footer-copyright">
            <?php
            $footerCopyright = isset($this->options->copyright) ? trim((string) $this->options->copyright) : '';
            if ($footerCopyright !== '') {
                echo '<span class="footer-custom">' . htmlspecialchars($footerCopyright, ENT_QUOTES, 'UTF-8') . '</span>';
            } else {
                $footerSiteTitle = htmlspecialchars((string) $this->options->title, ENT_QUOTES, 'UTF-8');
                echo '<span class="footer-copy">&copy;</span> ';
                echo '<span class="footer-years">' . date('Y') . '</span> ';
                echo '<span class="footer-sep">|</span> ';
                echo '<a href="' . $this->options->siteUrl . '" class="footer-site-link">' . $footerSiteTitle . '</a>';
            }
            ?>
...
<template id="tpl-search-popup">
    <div class="search-header">
        ...
        <form method="get" action="<?php $this->options->siteUrl(); ?>" id="search-form-popup" class="search-input-container" role="search">
