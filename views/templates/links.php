                    ...
                    <div class="pd-0 h-100 borderr-main-4 tra">
                        <div class="clearfix pd-20 bg-lvs' . $randColor . ' link-1">
                            <div class="col-md-12 pd-0 of-hide">
                                <strong><a title="' . $safeDesc . '" href="' . $safeUrl . '" target="_blank" rel="noopener" class="w-100 f14 color-fff link-name">' . $safeName . '</a></strong>
                        ...
                        <div class="pd-20 pt-10 pb-20 color-primary clearfix link-3 ">
                            <span class="pull-left color-aaa link_notes"><i class="fa fa-pencil-square-o" ></i>  ' . $safeNotes . '</span>
                                <span class="pull-right"><a title="' . $safeDesc . '" href="' . $safeUrl . '" target="_blank" rel="noopener" class="f14 color-aaa"><img class="favicon avatar" src="' . $ico . '" alt="' . $safeName . '"></a></span>
                        </div>
