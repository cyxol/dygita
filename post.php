...
<?php $this->need('views/components/sidebar-left.php'); ?>
        ...
        <footer class="article-footer">
            ...
            <div class="article-share">
                <h4><i class="fa fa-share-alt"></i> <?php dygita_e('分享到'); ?></h4>
                <div class="share-buttons">
                    <a href="#" class="share-btn wechat" title="<?php dygita_e('微信分享'); ?>" onclick="return window.DygitaShare && window.DygitaShare.shareToWechat();">
                        <i class="fa fa-weixin"></i>
                        <span><?php dygita_e('微信'); ?></span>
                    </a>
                    <a href="#" class="share-btn weibo" title="<?php dygita_e('微博分享'); ?>" onclick="return window.DygitaShare && window.DygitaShare.shareToWeibo();">
                        <i class="fa fa-weibo"></i>
                        <span><?php dygita_e('微博'); ?></span>
                    </a>
                    <a href="#" class="share-btn qq" title="<?php dygita_e('QQ分享'); ?>" onclick="return window.DygitaShare && window.DygitaShare.shareToQQ();">
                        <i class="fa fa-qq"></i>
                        <span>QQ</span>
                    </a>
                    <a href="#" class="share-btn copy" title="<?php dygita_e('复制链接'); ?>" onclick="return window.DygitaShare && window.DygitaShare.copyLink();">
                        <i class="fa fa-link"></i>
                        <span><?php dygita_e('复制'); ?></span>
                    </a>
                </div>
            </div>
        </footer>
        ...
        <nav class="article-nav">
            <span class="article-nav-prev"><?php $this->thePrev('%s', dygita_t('没有了')); ?></span>
            <span class="article-nav-next"><?php $this->theNext('%s', dygita_t('没有了')); ?></span>
        </nav>
